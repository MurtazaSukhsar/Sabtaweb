          ...
          {items.length === 0 ? (
            <div className="flex flex-col items-center justify-center py-16 text-center">
              ...
              <Link
                href="/products"
                onClick={closeDrawer}
                className="group relative mt-6 inline-flex h-10 items-center overflow-hidden rounded-lg btn-primary px-5 text-xs font-bold"
              >
                <span className="mr-6 transition-opacity duration-500 group-hover:opacity-0">Browse Products</span>
        ...
        {items.length > 0 && (
          <div className="space-y-3 border-t border-border bg-secondary p-5">
            ...
            <button
              ...
              className="group relative flex h-12 w-full items-center overflow-hidden rounded-lg btn-primary text-sm font-bold shadow-md"
            >
            ...
            <button
              ...
              className="group relative flex h-12 w-full items-center overflow-hidden rounded-lg bg-[#25D366] text-sm font-bold text-white shadow-md shadow-[#25D366]/20 transition-opacity hover:opacity-95"
            >
              <span className="mx-auto mr-8 flex items-center gap-2.5 transition-opacity duration-500 group-hover:opacity-0">
