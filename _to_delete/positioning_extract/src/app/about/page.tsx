          ...
          <ScrollReveal delay={150}>
            <div>
              ...
              <div className="mt-6 flex max-w-prose flex-col gap-5 text-pretty text-sm leading-relaxed text-muted-foreground md:text-base">
                <p>
                  Sabta Trading Co. LLC is a Dubai-based company founded in {siteConfig.founded} as a fastener and marine
                  rigging hardware distributor, catering all types of fasteners and rigging hardware mainly to the
                  Automotive, Manufacturing, Marine and Oilfield industries.
                </p>
                <p>
