...
import { Boxes, CalendarDays, Layers, Users } from "lucide-react"
import { Breadcrumbs } from "@/components/breadcrumbs"
import { AnimatedCounter } from "@/components/animated-counter"
import { ScrollReveal } from "@/components/scroll-reveal"
import { CtaBanner } from "@/components/home/cta-banner"
import { Industries } from "@/components/home/industries"
import { catalogPagePath, categories, contactInfo, siteConfig } from "@/lib/site-data"

export const metadata: Metadata = {
  title: "About Us",
  description: `${siteConfig.name}, Dubai-based fastener distributor since ${siteConfig.founded}. Learn about our company profile and the industries we serve.`,
}
...
export default function AboutPage() {
  ...
  const stats = [
    ...
    { icon: Users, value: 3, suffix: "", label: "Direct Sales Contacts" },
  ]
      ...
      <section className="bg-primary">
        <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 sm:py-20 md:px-8 md:py-24 lg:px-12">
          ...
          <h1 className="mt-4 max-w-3xl text-balance text-3xl font-extrabold uppercase tracking-tight text-primary-foreground md:text-5xl lg:text-6xl">
            A Fastener Distributor Since {siteConfig.founded}
          </h1>
        </div>
      </section>
        ...
        <div className="mt-12 grid items-center gap-12 lg:grid-cols-2 lg:gap-20">
          <ScrollReveal>
            <div className="relative aspect-[4/3] overflow-hidden rounded-2xl border border-border bg-white">
              <Image src={catalogPagePath(2)} alt="Sabta Trading Co. LLC company profile page" fill sizes="(max-width: 1024px) 100vw, 50vw" className="object-cover object-top" />
            </div>
          </ScrollReveal>
          <ScrollReveal delay={150}>
            <div>
              ...
              <div className="mt-6 flex max-w-prose flex-col gap-5 text-pretty text-sm leading-relaxed text-muted-foreground md:text-base">
                <p>
                  Sabta Trading Co. LLC is a Dubai-based company founded in {siteConfig.founded} as a fastener distributor,
                  catering all types of fasteners mainly to the Automotive, Manufacturing, Marine and Oilfield industries.
                </p>
                <p>
                  With vast expertise and knowledge throughout these years we have set standards for customer service by
                  providing solutions to our clients&rsquo; problems.
                </p>
                <p>
                  We have succeeded in our industry through commitment, efficiency and determination in providing quality
                  products, with a huge inventory of {siteConfig.itemsInStock} items in stock at competitive pricing. Our
                  products get updated regularly to meet our valued clients&rsquo; demands.
                </p>
                <p>
                  With our dedicated list of suppliers, we can source any type of fastener that isn&rsquo;t available in
                  ready stock.
                </p>
              </div>
              <Link href="/contact" className="mt-8 inline-flex h-13 items-center rounded-lg btn-primary px-8 text-sm">
                Get In Touch
              </Link>
            </div>
          </ScrollReveal>
